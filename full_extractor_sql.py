...
def insert_clinvar(my_cursor, clinvar, graph_id):
    ...
    result = my_cursor.execute(mySql_insert_query,
                               (clinvar['variantID'], clinvar['gene'], clinvar['pDot'], clinvar['cDot'],
                                clinvar['significance'], clinvar['signficanceExplanation'], str(clinvar['cdot_pos']),
                                str(clinvar['pdot_pos']), graph_id))
...
def insert_ocp_variant(my_cursor,name,omnigene_id,description_id, pdot,cdot,gdot,regionType,regionValue,indelType,variantType,variantProteinEffect,
    ...
    mySql_insert_query = "INSERT INTO ocp_variant (variantName,omniGene_gene_Id,description_id,pDot,cDot,gDot,regionType,regionValue,indelType,variantType,variantProteinEffect,jax_variant_Id,go_variant_Id,clinvar_variant_Id,hot_spot_variant_Id,exon,graph_id) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
    result = my_cursor.execute(mySql_insert_query,(name,omnigene_id,description_id, pdot,cdot,gdot,regionType,regionValue,indelType,variantType,variantProteinEffect,jax_variant_id,
